...
contract Tornado is ReentrancyGuard{
    ...
    uint256 public coin_size = 0.0001 ether;
    ...
    function deposit(uint256 _commitment) external payable nonReentrant {
        require(msg.value == coin_size, "incorrect-amount");
        require(!commitments[_commitment], "commitment already exist");
        require(nextLeafIndex < 2 ** level, "tree-full");
    ...
    function withdraw(
        ...
        (bool ok, ) = target.call{ value: coin_size }("");
